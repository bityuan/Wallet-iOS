...
- (nullable NSURLSessionDataTask *)sendRequestMethod:(HTTPMethod)requestMethod
    ...
    [self.sessionManager.requestSerializer setValue:[GoFunction getSeesionIdWithAppSymbol:APPSYMBOL AppKey:APPKEY] forHTTPHeaderField:@"SessionId"];
