...
+ (void)getInscriptionBalance:(NSString *)addr success:(requestSuccessBlock)successBlock failure:(requestFailuresBlock)failureBlock
{
    NSString *apiPath = [NSString stringWithFormat:@"/api/v1/inscription/balance/%@",addr];
    
    [[SGNetWork defaultManager] sendRequestMethod:HTTPMethodGET
                                        serverUrl:InscriptionURL
                                          apiPath:apiPath
                                       parameters:nil
                                         progress:nil
                                          success:^(BOOL isSuccess, id  _Nullable responseObject) {
...
{
    NSString *apiPath = [NSString stringWithFormat:@"/api/v1/inscription/history/%@/%@/%@/%@",addr,name,index,count];
    [[SGNetWork defaultManager] sendRequestMethod:HTTPMethodGET
                                        serverUrl:InscriptionURL
                                          apiPath:apiPath
                                       parameters:nil
