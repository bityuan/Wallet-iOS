...
//        }
        ...
        [self.qrCodeBtn setImage:[CommonFunction createImgQRCodeWithString:coin.coin_address centerImage:self.coinImage.image] forState:UIControlStateNormal];
        [self.qrCodeBtn setImage:[CommonFunction createImgQRCodeWithString:coin.coin_address centerImage:self.coinImage.image] forState:UIControlStateHighlighted];
    }
