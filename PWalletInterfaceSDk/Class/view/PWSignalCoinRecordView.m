...
- (void)createView
{
    ...
    [self.recordBtn setTitle:@"查看历史转账记录".localized forState:UIControlStateNormal];
...
- (void)setRecordCount:(NSInteger)recordCount
{
    ...
    self.recordCountLab.text = [NSString stringWithFormat:@"   已转%li次".localized,recordCount];
