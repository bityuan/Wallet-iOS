...
- (void)createView {
    ...
    titleLab.text = [NSString stringWithFormat:@"  %@",@"发送数量".localized];
    ...
    balanceLab.text = @"余额：--BTC".localized;
    ...
    [btn setTitle:@"请选择编号".localized forState:UIControlStateNormal];
    ...
    moneyText.placeholder = @"请输入数量".localized;
...
- (void)setCoin:(LocalCoin *)coin {
    ...
    self.balanceLab.text = [NSString stringWithFormat:@"%@:%@%@",@"余额".localized,balanceStr,coin.optional_name];
