...
- (void)createView {
    ...
    titleLab.text = [NSString stringWithFormat:@"  %@",@"矿工费".localized];
...
//        for (LocalCoin *localCoin in coinDatasource)
//        {
//            if ([localCoin.coin_type isEqualToString:@"WW"]){
//                self.moneyLab.text = @"0.003 WW";
//                self.feeValue = 0.003;
//            }else if([localCoin.coin_chain isEqualToString:@"ETH"] && ![localCoin.coin_platform isEqualToString:@"ethereum"]){
//                // ybf币的特殊处理
//                self.moneyLab.text = @"0.5";
//                self.feeValue = 0.5;
//            }
//            else{
//                if (localCoin.treaty == 2
//                    && [localCoin.coin_platform isEqualToString:self.coin.coin_platform])
//                {
//                    NSString *numString = [NSString stringWithFormat:@"%lf", self.feeValue];
//                    self.moneyLab.text = [NSString stringWithFormat:@"%@  %@", [CommonFunction removeZeroFromMoney: numString],localCoin.coin_type];
//                }
//                else
//                {
//                    if (localCoin.treaty == 1
//                        && [localCoin.coin_platform isEqualToString:self.coin.coin_platform]
//                        && [self.coin isBtyChild])
//                    {
//                        NSString *numString = [NSString stringWithFormat:@"%lf", self.feeValue];
