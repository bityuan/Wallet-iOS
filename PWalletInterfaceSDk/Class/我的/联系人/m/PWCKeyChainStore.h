...
extern NSString * const PWCKeyChainStoreErrorDomain;
...
@interface PWCKeyChainStore : NSObject
...
+ (PWCKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (PWCKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
@interface PWCKeyChainStore (ErrorHandling)
...
@interface PWCKeyChainStore (ForwardCompatibility)
...
@interface PWCKeyChainStore (Deprecation)
