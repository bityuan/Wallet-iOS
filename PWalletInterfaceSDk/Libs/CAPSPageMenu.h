...
@property (nonatomic) NSString *selectionIndicatorLength;
...
extern NSString * const CAPSPageMenuOptionSelectionIndicatorLength;
extern NSString * const CAPSPageMenuOptionHideStartingMenuMargin;
extern NSString * const CAPSPageMenuOptionHideIndicator;
